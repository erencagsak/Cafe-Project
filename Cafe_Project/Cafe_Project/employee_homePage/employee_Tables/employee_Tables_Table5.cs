...
{
    public partial class employee_Tables_Table5 : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();
        public employee_Tables_Table5()
        {
            InitializeComponent();
        }
        private void employee_Tables_Table5_Load(object sender, EventArgs e)
        {
            screenSettings();
            // Ekranı ayarla.
