...
{
    public partial class employee_Tables_Table8 : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();
        public employee_Tables_Table8()
        {
            InitializeComponent();
        }
        private void employee_Tables_Table8_Load(object sender, EventArgs e)
        {
            screenSettings();
            // Ekranı ayarla.
