...
{
    public partial class employee_Tables_Table2 : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();
        public employee_Tables_Table2()
        {
            InitializeComponent();
        }
        private void employee_Tables_Table2_Load(object sender, EventArgs e)
        {
            screenSettings();
            // Ekranı ayarla.
