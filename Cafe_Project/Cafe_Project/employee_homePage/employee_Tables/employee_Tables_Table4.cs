...
{
    public partial class employee_Tables_Table4 : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();
        public employee_Tables_Table4()
        {
            InitializeComponent();
        }
        private void employee_Tables_Table4_Load(object sender, EventArgs e)
        {
            screenSettings();
            // Ekranı ayarla.
