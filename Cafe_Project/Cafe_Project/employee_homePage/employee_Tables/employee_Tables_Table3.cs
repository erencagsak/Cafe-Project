...
{
    public partial class employee_Tables_Table3 : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();
        public employee_Tables_Table3()
        {
            InitializeComponent();
        }
        private void employee_Tables_Table3_Load(object sender, EventArgs e)
        {
            screenSettings();
            // Ekranı ayarla.
