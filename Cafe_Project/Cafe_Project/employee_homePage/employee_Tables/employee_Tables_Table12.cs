...
{
    public partial class employee_Tables_Table12 : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();
        public employee_Tables_Table12()
        {
            InitializeComponent();
        }
        private void employee_Tables_Table12_Load(object sender, EventArgs e)
        {
            screenSettings();
            // Ekranı ayarla.
