...
{
    public partial class employee_Tables_Table11 : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();
        public employee_Tables_Table11()
        {
            InitializeComponent();
        }
        private void employee_Tables_Table11_Load(object sender, EventArgs e)
        {
            screenSettings();
            // Ekranı ayarla.
