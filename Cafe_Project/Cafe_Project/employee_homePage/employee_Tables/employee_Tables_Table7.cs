...
{
    public partial class employee_Tables_Table7 : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();
        public employee_Tables_Table7()
        {
            InitializeComponent();
        }
        private void employee_Tables_Table7_Load(object sender, EventArgs e)
        {
            screenSettings();
            // Ekranı ayarla.
