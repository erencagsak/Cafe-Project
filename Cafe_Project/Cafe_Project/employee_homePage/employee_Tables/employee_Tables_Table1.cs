...
{
    public partial class employee_Tables_Table1 : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();
        public employee_Tables_Table1()
        {
            InitializeComponent();
        }
        private void employee_Tables_Table1_Load(object sender, EventArgs e)
        {
            screenSettings();
            // Ekranı ayarla.
