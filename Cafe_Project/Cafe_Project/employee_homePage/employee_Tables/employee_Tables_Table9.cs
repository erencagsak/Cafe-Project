...
{
    public partial class employee_Tables_Table9 : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();
        public employee_Tables_Table9()
        {
            InitializeComponent();
        }
        private void employee_Tables_Table9_Load(object sender, EventArgs e)
        {
            screenSettings();
            // Ekranı ayarla.
