...
{
    public partial class employee_Tables_Table6 : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();
        public employee_Tables_Table6()
        {
            InitializeComponent();
        }
        private void employee_Tables_Table6_Load(object sender, EventArgs e)
        {
            screenSettings();
            // Ekranı ayarla.
