...
{
    public partial class manager_Tables : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();
        public manager_Tables()
        {
            InitializeComponent();
        }
        private void manager_Tables_Load(object sender, EventArgs e)
        {
            screenSettings();
        ...
        {
            manager_Tables_Table1 manager_Tables_Table1 = new manager_Tables_Table1();

            manager_Tables_Table1.Show();
        ...
        {
            manager_Tables_Table2 manager_Tables_Table2 = new manager_Tables_Table2();

            manager_Tables_Table2.Show();
        ...
        {
            manager_Tables_Table3 manager_Tables_Table3 = new manager_Tables_Table3();

            manager_Tables_Table3.Show();
        ...
        {
            manager_Tables_Table4 manager_Tables_Table4 = new manager_Tables_Table4();

            manager_Tables_Table4.Show();
        ...
        {
            manager_Tables_Table5 manager_Tables_Table5 = new manager_Tables_Table5();

            manager_Tables_Table5.Show();
        ...
        {
            manager_Tables_Table6 manager_Tables_Table6 = new manager_Tables_Table6();

            manager_Tables_Table6.Show();
        ...
        {
            manager_Tables_Table7 manager_Tables_Table7 = new manager_Tables_Table7();

            manager_Tables_Table7.Show();
        ...
        {
            manager_Tables_Table8 manager_Tables_Table8 = new manager_Tables_Table8();

            manager_Tables_Table8.Show();
        ...
        {
            manager_Tables_Table9 manager_Tables_Table9 = new manager_Tables_Table9();

            manager_Tables_Table9.Show();
        ...
        {
            manager_Tables_Table10 manager_Tables_Table10 = new manager_Tables_Table10();

            manager_Tables_Table10.Show();
        ...
        {
            manager_Tables_Table11 manager_Tables_Table11 = new manager_Tables_Table11();

            manager_Tables_Table11.Show();
        ...
        {
            manager_Tables_Table12 manager_Tables_Table12 = new manager_Tables_Table12();

            manager_Tables_Table12.Show();
        ...
        public void change_Color_Table1()
        {
            ...
            // Masa 1 doluysa masanın rengini kırmızı, eğer boşsa yeşil olarak değiştir.
        }
        public void change_Color_Table2()
        {
            ...
            // Masa 2 doluysa masanın rengini kırmızı, eğer boşsa yeşil olarak değiştir.
        }
        public void change_Color_Table3()
        {
            ...
            // Masa 3 doluysa masanın rengini kırmızı, eğer boşsa yeşil olarak değiştir.
        }
        ...
        public void change_Color_Table5()
        {
            ...
            // Masa 5 doluysa masanın rengini kırmızı, eğer boşsa yeşil olarak değiştir.
        }
        public void change_Color_Table6()
        {
            ...
            // Masa 6 doluysa masanın rengini kırmızı, eğer boşsa yeşil olarak değiştir.
        }
        public void change_Color_Table7()
        {
            ...
            // Masa 7 doluysa masanın rengini kırmızı, eğer boşsa yeşil olarak değiştir.
        }
        public void change_Color_Table8()
        {
            ...
            // Masa 8 doluysa masanın rengini kırmızı, eğer boşsa yeşil olarak değiştir.
        }
        public void change_Color_Table9()
        {
            ...
            // Masa 9 doluysa masanın rengini kırmızı, eğer boşsa yeşil olarak değiştir.
        }
        public void change_Color_Table10()
        {
            ...
            // Masa 10 doluysa masanın rengini kırmızı, eğer boşsa yeşil olarak değiştir.
        }
        public void change_Color_Table11()
        {
            ...
            // Masa 11 doluysa masanın rengini kırmızı, eğer boşsa yeşil olarak değiştir.
        }
        public void change_Color_Table12()
        {
            ...
            // Masa 12 doluysa masanın rengini kırmızı, eğer boşsa yeşil olarak değiştir.
        }
    }
}