...
{
    public partial class manager_Tables_Table10 : DevExpress.XtraEditors.XtraForm
    {
        BaglantiSinif bgl = new BaglantiSinif();

        // SQL bağlantılarını açar.
        public manager_Tables_Table10()
        {
            InitializeComponent();
        }
        ...
        private void manager_Tables_Table10_Load(object sender, EventArgs e)
        {
            screenSettings();
            // Ekranı ayarla.
